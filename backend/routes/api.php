...
// =====================
// 📋 RESUMEN DE LO FUSIONADO
// =====================

// ✅ MANTENIDO DEL PRIMER ARCHIVO:
// - Rate limiting en login (throttle:5,1)
// - Búsquedas rápidas (/users/simple, /orders/search)
// - Tablero Trello (/orders/board)
// - Calendario (/orders/calendar)
// - Mover orden (/orders/{order}/move)
// - Actualizar estado (/orders/{id}/status)
// - Clientes (/clients)
// - Estados (/statuses)
// - Notificaciones (/notifications)
// - Auditoría (/audit/order-status)

// ✅ MANTENIDO DEL SEGUNDO ARCHIVO:
// - Control de usuarios completo (/users)
// - Roles middleware aplicado
// - Ruta /orders-next-number
// - Mejor estructura de grupos por roles

// ✅ ELIMINADO (DUPLICADOS):
// - Ruta POST /orders (ahora está en grupo de roles)
// - Ruta GET /orders (ahora está en grupo de roles)
// - Ruta GET /orders/{id} (ahora está en grupo de roles)
// - Ruta PUT /orders/{id} (ahora está como PUT /orders/{order})
// - Ruta DELETE /orders/{id} (ahora está como DELETE /orders/{order})

// ✅ MEJORAS APLICADAS:
// 1. Todas las rutas de órdenes ahora tienen control de roles
// 2. Estructura más organizada con comentarios
// 3. Middleware RoleMiddleware aplicado correctamente
// 4. Rutas agrupadas lógicamente